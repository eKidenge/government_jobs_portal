...
class Payment(models.Model):
    ...
    MPESA_TRANSACTION_TYPES = [
        ('paybill', 'Paybill'),
        ('till', 'Till (Buy Goods)'),  # ✅ Added for clarity
    ]
    ...
    mpesa_transaction_type = models.CharField(
        max_length=20, 
        choices=MPESA_TRANSACTION_TYPES, 
        blank=True, 
        null=True,
        help_text="Paybill or Till (Buy Goods)"
    )
    till_number = models.CharField(
        max_length=20, 
        blank=True, 
        null=True,
        help_text="Your Till number for Buy Goods transactions"
    )
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['mpesa_transaction_type']),  # ✅ Added for Till queries
        ]
    ...
    # ✅ New helper method for Till transactions
    def is_till_transaction(self):
        """Check if this is a Till (Buy Goods) transaction"""
        return self.mpesa_transaction_type == 'till'
    
    # ✅ New helper method for Paybill transactions
    def is_paybill_transaction(self):
        """Check if this is a Paybill transaction"""
        return self.mpesa_transaction_type == 'paybill'
