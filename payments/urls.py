...
urlpatterns = [
    ...
    # Changed <uuid:payment_id> → <int:payment_id>
    ...
    path('payment/<int:payment_id>/receipt/', views.download_receipt, name='download_receipt'),
    path('payment/<int:payment_id>/receipt-view/', views.view_receipt, name='view_receipt'),
    ...
    path('admin/payments/verify/<int:payment_id>/', views.admin_verify_payment, name='admin_verify_payment'),
    path('admin/payments/refund/<int:payment_id>/', views.admin_refund_payment, name='admin_refund_payment'),
    ...
    # INVOICES
    # ==============================================
    path('payment/invoice/<int:payment_id>/', views.generate_invoice, name='generate_invoice'),
    ...
    path('api/payments/status/<int:payment_id>/', views.api_payment_status, name='api_payment_status'),
    path('api/payments/history/', views.api_payment_history, name='api_payment_history'),
    path('api/payments/verify/<int:payment_id>/', views.api_verify_payment, name='api_verify_payment'),
