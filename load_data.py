...
def load_categories():
    ...
    categories_data = [
        ...
        {'name': 'Space & Aerospace', 'icon': 'fa-rocket', 'description': 'Space technology and aerospace positions', 'is_active': True},
    ]
...
def load_employers():
    ...
    employers_data = [
        ...
        # === NEW: Kenya Space Agency ===
        {
            'company_name': 'Kenya Space Agency',
            'registration_number': 'KSA/2024/001',
            'license_number': 'KSA-LIC-001',
            'industry': 'government',
            'contact_phone': '+254-20-222-7000',
            'contact_email': 'info@ksa.go.ke',
            'address': 'KSA Headquarters, Nairobi, Kenya',
            'country': kenya,
            'is_verified': True,
            'description': 'Kenya Space Agency - Government agency responsible for space science, technology, and satellite applications',
            'website': 'https://www.ksa.go.ke',
            'company_size': '201-500'
        }
    ]
...
def load_sample_jobs():
    ...
    try:
        categories = {
            ...
            'space': Category.objects.get(name='Space & Aerospace'),  # new category for KSA jobs
        }
    ...
    try:
        ...
        # New employer
        ksa = EmployerProfile.objects.get(company_name='Kenya Space Agency')
    ...
    jobs_data = [
        # === KENYA AGENCY JOBS === (existing - kept as is)
        {
        ...
        # === INTERNATIONAL AGENCY JOBS === (existing)
        {
        ...
        # ========================================================
        # KENYA SPACE AGENCY JOBS (30 positions as advertised)
        # ========================================================
        {
            ...
            'country': kenya,
            'category': categories['admin'],
            'description': 'Provide administrative and clerical support to the agency.',
            'responsibilities': 'General office duties, document management, reception, filing, and assisting staff.',
            'requirements': 'KCSE certificate, proficiency in office software, and good communication skills.',
            'benefits': 'Medical cover, Pension, Housing allowance, Training opportunities',
            'salary_min': Decimal('33153'),
            'salary_max': Decimal('43099'),
            'salary_currency': 'KES',
            'is_salary_negotiable': False,
            'employment_type': 'full_time',
        ...
        },
        {
            ...
            'country': kenya,
            'category': categories['transport'],
            'description': 'Provide safe and reliable driving services for agency staff and vehicles.',
            'responsibilities': 'Driving official vehicles, vehicle maintenance, record keeping, and safety compliance.',
            'requirements': 'Valid driving license, clean driving record, and basic vehicle maintenance skills.',
            'benefits': 'Medical cover, Pension, Housing allowance, Training',
            'salary_min': Decimal('43337'),
            'salary_max': Decimal('53522'),
            'salary_currency': 'KES',
            'is_salary_negotiable': False,
            'employment_type': 'full_time',
            'experience_level': 'entry',
        ...
        },
        {
            ...
            'country': kenya,
            'category': categories['admin'],
            'description': 'Oversee office administrative duties and supervise junior staff.',
            'responsibilities': 'Office management, staff supervision, procurement support, and record keeping.',
            'requirements': 'Diploma in office administration or related field, 3+ years experience.',
            'benefits': 'Medical cover, Pension, Housing allowance, Training',
            'salary_min': Decimal('43337'),
            'salary_max': Decimal('53522'),
            'salary_currency': 'KES',
        ...
        {
            'title': 'Assistant Corporate Communications Officer',
            'agency': None,
            'employer': ksa,
            'country': kenya,
            'category': categories['communications'],
            'description': 'Assist in developing and implementing corporate communication strategies.',
            'responsibilities': 'Content creation, media relations, social media management, and internal communications.',
            'requirements': 'Bachelor\'s degree in Communications or related field, 2+ years experience.',
            'benefits': 'Medical cover, Pension, Training, Professional development',
            'salary_min': Decimal('50945'),
            'salary_max': Decimal('66229'),
            'salary_currency': 'KES',
            'is_salary_negotiable': False,
            'employment_type': 'full_time',
            'experience_level': 'mid',
        ...
        {
            'title': 'Space Infrastructure and Facility Development Officer',
            'agency': None,
            'employer': ksa,
            'country': kenya,
            'category': categories['space'],
            'description': 'Oversee the development of space infrastructure and facility projects.',
            'responsibilities': 'Project planning, infrastructure development, facility management, and coordination.',
            'requirements': 'Degree in Engineering or related field, 4+ years experience in infrastructure projects.',
            'benefits': 'Medical cover, Pension, Housing allowance, Training, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
            'is_salary_negotiable': False,
            'employment_type': 'full_time',
            'experience_level': 'mid',
        ...
        {
            'title': 'Space Science and Astronomy Officer',
            'agency': None,
            'employer': ksa,
            'country': kenya,
            'category': categories['space'],
            'description': 'Conduct space science research and astronomical observations.',
            'responsibilities': 'Astronomical research, data analysis, scientific publications, and public outreach.',
            'requirements': 'Degree in Physics, Astronomy, or related field. 4+ years experience in space science.',
            'benefits': 'Medical cover, Pension, Research support, Training, Conferences',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
            'is_salary_negotiable': False,
        ...
        {
            'title': 'Space Operations and Systems Engineer',
            'agency': None,
            'employer': ksa,
            'country': kenya,
            'category': categories['space'],
            'description': 'Design and manage space operations systems and satellite missions.',
            'responsibilities': 'Systems engineering, mission planning, satellite operations, and system integration.',
            'requirements': 'Degree in Aerospace Engineering or related field. 5+ years experience in space systems.',
            'benefits': 'Medical cover, Pension, Training, Professional development, International exposure',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
            'is_salary_negotiable': False,
        ...
        {
            'title': 'Navigation and Positioning Officer',
            'agency': None,
            'employer': ksa,
            'country': kenya,
            'category': categories['space'],
            'description': 'Manage navigation and positioning systems for space applications.',
            'responsibilities': 'GNSS operations, positioning data analysis, system maintenance, and user support.',
            'requirements': 'Degree in Geomatics, Engineering, or related field. 4+ years experience in navigation systems.',
            'benefits': 'Medical cover, Pension, Training, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
        ...
        {
            'title': 'Satellite Communication Officer',
            'agency': None,
            'employer': ksa,
            'country': kenya,
            'category': categories['space'],
            'description': 'Manage satellite communication systems and ground stations.',
            'responsibilities': 'Satellite link management, ground station operations, signal analysis, and fault handling.',
            'requirements': 'Degree in Telecommunications or related field. 4+ years experience in satellite communications.',
            'benefits': 'Medical cover, Pension, Training, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
        ...
        },
        {
            ...
            'description': 'Conduct surveillance operations using space-based assets.',
            'responsibilities': 'Surveillance planning, data analysis, reporting, and coordination with security agencies.',
            'requirements': 'Degree in Security Studies or related field. 4+ years experience in surveillance operations.',
            'benefits': 'Medical cover, Pension, Training, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
        ...
        },
        {
            ...
            'country': kenya,
            'category': categories['security'],
            'description': 'Enforce space regulations and compliance standards.',
            'responsibilities': 'Compliance monitoring, inspections, investigation, and reporting.',
            'requirements': 'Degree in Law or related field. 4+ years experience in enforcement or regulatory roles.',
            'benefits': 'Medical cover, Pension, Training, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
        ...
        {
            'title': 'Remote Sensing Officer',
            'agency': None,
            'employer': ksa,
            'country': kenya,
            'category': categories['space'],
            'description': 'Analyze remote sensing data for earth observation applications.',
            'responsibilities': 'Image processing, data analysis, GIS integration, and reporting.',
            'requirements': 'Degree in Remote Sensing, Geomatics, or related field. 4+ years experience.',
            'benefits': 'Medical cover, Pension, Training, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
        ...
        {
            'title': 'Geographic Information Systems Officer',
            'agency': None,
            'employer': ksa,
            'country': kenya,
            'category': categories['space'],
            'description': 'Manage GIS databases and spatial analysis for the agency.',
            'responsibilities': 'GIS data management, analysis, mapping, and application development.',
            'requirements': 'Degree in GIS, Geomatics, or related field. 4+ years experience in GIS.',
            'benefits': 'Medical cover, Pension, Training, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
        ...
        {
            'title': 'Geo-Information & Data Management Officer',
            'agency': None,
            'employer': ksa,
            'country': kenya,
            'category': categories['space'],
            'description': 'Oversee geo-information systems and data management practices.',
            'responsibilities': 'Data governance, database administration, data quality, and spatial data infrastructure.',
            'requirements': 'Degree in Geoinformatics or related field. 4+ years experience in data management.',
            'benefits': 'Medical cover, Pension, Training, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
        ...
        },
        {
            ...
            'country': kenya,
            'category': categories['it'],
            'description': 'Develop and maintain software systems for space applications.',
            'responsibilities': 'Software design, development, testing, deployment, and maintenance.',
            'requirements': 'Degree in Computer Science or related field. 4+ years experience in software engineering.',
            'benefits': 'Medical cover, Pension, Training, Flexible work, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
            'is_salary_negotiable': False,
        ...
        {
            'title': 'Space Digital Infrastructure Officer',
            'agency': None,
            'employer': ksa,
            'country': kenya,
            'category': categories['space'],
            'description': 'Manage digital infrastructure for space missions and operations.',
            'responsibilities': 'IT infrastructure, cloud services, data centers, and cybersecurity.',
            'requirements': 'Degree in IT or related field. 4+ years experience in digital infrastructure.',
            'benefits': 'Medical cover, Pension, Training, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
        ...
        {
            'title': 'Space Research & Innovation Officer',
            'agency': None,
            'employer': ksa,
            'country': kenya,
            'category': categories['research'],
            'description': 'Lead research and innovation initiatives in space science.',
            'responsibilities': 'Research planning, project management, innovation scouting, and technology transfer.',
            'requirements': 'Degree in Science or Engineering. 4+ years experience in research and innovation.',
            'benefits': 'Medical cover, Pension, Research funding, Training, Conferences',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
            'is_salary_negotiable': False,
        ...
        {
            'title': 'Space Education & Awareness Officer',
            'agency': None,
            'employer': ksa,
            'country': kenya,
            'category': categories['education'],
            'description': 'Promote space education and public awareness of space activities.',
            'responsibilities': 'Public outreach, educational programs, curriculum development, and media engagement.',
            'requirements': 'Degree in Education or Communication. 4+ years experience in educational outreach.',
            'benefits': 'Medical cover, Pension, Training, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
        ...
        },
        {
            ...
            'country': kenya,
            'category': categories['admin'],
            'description': 'Coordinate strategic planning and performance monitoring.',
            'responsibilities': 'Strategic planning, performance reporting, project monitoring, and budget planning.',
            'requirements': 'Degree in Planning or related field. 4+ years experience in planning roles.',
            'benefits': 'Medical cover, Pension, Training, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
        ...
        },
        {
            ...
            'country': kenya,
            'category': categories['admin'],
            'description': 'Ensure quality standards in agency processes and outputs.',
            'responsibilities': 'Quality audits, process improvement, compliance checks, and reporting.',
            'requirements': 'Degree in Quality Management or related field. 4+ years experience in QA.',
            'benefits': 'Medical cover, Pension, Training, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
        ...
        },
        {
            ...
            'country': kenya,
            'category': categories['finance'],
            'description': 'Manage financial operations and accounting functions.',
            'responsibilities': 'Budgeting, financial reporting, cash flow management, and compliance.',
            'requirements': 'Degree in Finance or Accounting. CPA(K) or equivalent. 4+ years experience.',
            'benefits': 'Medical cover, Pension, Training, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
        ...
        },
        {
            ...
            'country': kenya,
            'category': categories['finance'],
            'description': 'Manage financial records and ensure accurate accounting.',
            'responsibilities': 'General ledger, financial statements, reconciliations, and tax compliance.',
            'requirements': 'Degree in Accounting. CPA(K) or ACCA. 4+ years experience in accounting.',
            'benefits': 'Medical cover, Pension, Training, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
        ...
        },
        {
            ...
            'country': kenya,
            'category': categories['finance'],
            'description': 'Conduct internal audits to ensure compliance and efficiency.',
            'responsibilities': 'Audit planning, risk assessment, internal controls, and reporting.',
            'requirements': 'Degree in Accounting or Audit. Certified Internal Auditor (CIA) preferred. 4+ years experience.',
            'benefits': 'Medical cover, Pension, Training, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
        ...
        },
        {
            ...
            'country': kenya,
            'category': categories['hr'],
            'description': 'Manage human resource functions and employee relations.',
            'responsibilities': 'Recruitment, training, performance management, employee relations, and policy implementation.',
            'requirements': 'Degree in HR Management. CHRP certification preferred. 4+ years experience.',
            'benefits': 'Medical cover, Pension, Training, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
        ...
        },
        {
            ...
            'country': kenya,
            'category': categories['admin'],
            'description': 'Coordinate administrative functions and office management.',
            'responsibilities': 'Office administration, procurement, asset management, and staff support.',
            'requirements': 'Degree in Administration or related field. 4+ years experience in administration.',
            'benefits': 'Medical cover, Pension, Training, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
        ...
        },
        {
            ...
            'country': kenya,
            'category': categories['communications'],
            'description': 'Lead corporate communications strategies and media engagement.',
            'responsibilities': 'Public relations, media relations, crisis communication, and internal communications.',
            'requirements': 'Degree in Communications or related field. 5+ years experience in corporate communications.',
            'benefits': 'Medical cover, Pension, Training, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
        ...
        },
        {
            ...
            'country': kenya,
            'category': categories['legal'],
            'description': 'Provide legal advisory services and ensure regulatory compliance.',
            'responsibilities': 'Legal research, contract review, compliance, litigation support, and policy drafting.',
            'requirements': 'Bachelor of Laws (LLB). 4+ years experience in legal practice. Advocate of the High Court.',
            'benefits': 'Medical cover, Pension, Training, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
        ...
        },
        {
            ...
            'responsibilities': 'Procurement planning, supplier management, inventory control, and compliance.',
            'requirements': 'Degree in Supply Chain Management or related field. 4+ years experience in procurement.',
            'benefits': 'Medical cover, Pension, Training, Professional development',
            'salary_min': Decimal('82173'),
            'salary_max': Decimal('106825'),
            'salary_currency': 'KES',
        ...
        {
            'title': 'Principal Officer, Remote Sensing',
            'agency': None,
            'employer': ksa,
            'country': kenya,
            'category': categories['space'],
            'description': 'Lead remote sensing projects and applications for national development.',
            'responsibilities': 'Remote sensing research, project management, team leadership, and policy advisory.',
            'requirements': 'Master\'s degree in Remote Sensing or related field. 8+ years experience in remote sensing.',
            'benefits': 'Medical cover, Pension, Housing allowance, Research funding, International conferences',
            'salary_min': Decimal('133997'),
            'salary_max': Decimal('174197'),
            'salary_currency': 'KES',
            'is_salary_negotiable': False,
            'employment_type': 'full_time',
            'experience_level': 'senior',
        ...
        {
            'title': 'Principal Officer, Geographic Information System',
            'agency': None,
            'employer': ksa,
            'country': kenya,
            'category': categories['space'],
            'description': 'Lead GIS projects and spatial data management for the agency.',
            'responsibilities': 'GIS project management, spatial analysis, database administration, and policy development.',
            'requirements': 'Master\'s degree in GIS or related field. 8+ years experience in GIS management.',
            'benefits': 'Medical cover, Pension, Housing allowance, Research funding, International conferences',
            'salary_min': Decimal('133997'),
            'salary_max': Decimal('174197'),
            'salary_currency': 'KES',
