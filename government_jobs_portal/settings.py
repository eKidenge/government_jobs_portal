...
# ==============================================
# M-PESA SETTINGS - ✅ UPDATED FOR YOUR TILL NUMBER
# ==============================================

# M-PESA Configuration - Using your Till number
...
# ✅ UPDATED: YOUR TILL NUMBER (not the default sandbox Paybill)
MPESA_SHORTCODE = '1674453'  # Your actual Till number

# Environment: Use 'sandbox' for testing, 'production' for live
MPESA_ENVIRONMENT = 'production'  # Change to 'production' when going live

# ✅ Your main domain for the portal
SITE_URL = 'https://government-jobs-portal.onrender.com'

# ✅ Callback URLs using your main domain
...
# ✅ For backend API calls (if different from main site)
BACKEND_URL = 'https://dc-backend-6xlc.onrender.com'

# ✅ M-Pesa Transaction Type (Till = CustomerBuyGoodsOnline)
MPESA_TRANSACTION_TYPE = 'CustomerBuyGoodsOnline'  # For Till (Buy Goods)

# Alternative: Use environment variables for production
# Uncomment below and comment the hardcoded values above for production
# MPESA_CONSUMER_KEY = os.getenv('MPESA_CONSUMER_KEY', '')
# MPESA_CONSUMER_SECRET = os.getenv('MPESA_CONSUMER_SECRET', '')
# MPESA_PASSKEY = os.getenv('MPESA_PASSKEY', '')
# MPESA_SHORTCODE = os.getenv('MPESA_SHORTCODE', '1674453')
