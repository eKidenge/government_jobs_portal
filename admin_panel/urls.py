...
urlpatterns = [
    ...
    path('employers/<uuid:employer_id>/edit/', views.admin_employer_edit, name='admin_employer_edit'),
    path('employers/<uuid:employer_id>/unverify/', views.admin_employer_unverify, name='admin_employer_unverify'),
    path('employers/<uuid:employer_id>/jobs/', views.admin_employer_jobs, name='admin_employer_jobs'),
