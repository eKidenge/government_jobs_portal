...
# Payment models are registered in payments/admin.py – do NOT register them here
# from payments.models import Payment, PaymentPlan   # <-- REMOVED
...
# All other models are registered with @admin.register above.
# Payment and PaymentPlan are NOT registered here – they are handled by payments/admin.py.
